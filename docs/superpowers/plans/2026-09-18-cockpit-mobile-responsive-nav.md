...
- [ ] **Step 1: Tag the sidebar's root element**
...
- [ ] **Step 1: Confirm, don't implement**
...
- [ ] **Step 1: Import and mount `BottomNav`**
...
- [ ] **Step 2: Make the header wrap at narrow widths**
...
- [ ] **Step 1: Side-by-side comparison against the reference**
...
- [ ] **Step 2: Walk every screen via the mobile nav, both languages**
...
- [ ] **Step 3: Boundary check at the breakpoint**
