          ...
          : normalizeAIResult(
              {
                one_liner: cleanText
                  ...
                  : fallback.one_liner,
                trends: cleanText ? [cleanText.slice(0, 320)] : fallback.trends,
