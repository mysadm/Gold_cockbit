...
type AppState = {
  ...
  ai: { loading: boolean; error: string | null; data: AIResultV2 | null; at: string | null; applied: boolean; usedWebSearch: boolean; validationWarnings: string[]; providerLabel: string | null };
  newMonitor: string;
};
